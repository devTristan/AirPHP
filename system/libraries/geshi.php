...
/** The language file directory for GeSHi
	@access private */
define('GESHI_LANG_ROOT', DIR_DRIVERS . 'geshi/');
...
class geshi {
	 ...
	 * @var string
	 */
	private $language_path = GESHI_LANG_ROOT;
	 ...
	 */
	private $enable_important_blocks = false;
	 ...
	 */
	private $important_styles = 'font-weight: bold; color: red;'; // Styles for important parts of the code
...
//		$result = substr($result, 1, -1);
	...
	*/
	...
	public static function highlight($source, $language) {
		return n('geshi', $source, $language)->parse_code();
	}
} // End Class GeSHi
